...
#   */5 * * * * /home/ubuntu/glitch-social-media-agent/scripts/sheet_posting_tick.sh \
#     >> /home/ubuntu/.local/state/glitch-social-media-agent/logs/sheet-posting.log 2>&1
#
...
set -euo pipefail
cd /home/ubuntu/glitch-social-media-agent
