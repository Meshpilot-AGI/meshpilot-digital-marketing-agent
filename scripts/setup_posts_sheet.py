...
SEED_POSTS: list[dict[str, str]] = [
    ...
    },
    {
        "brand_id": "glitch_executor", "platform": "upload_post_x",
        "body": (
            "Autonomous action layer on Mesh Pilot:\n\n"
    ...
    },
    {
        "brand_id": "glitch_executor", "platform": "upload_post_linkedin",
        "body": (
            "Mesh Pilot's autonomous action layer went live this week.\n\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "For one client on our Mesh Pilot stack, the Meta dashboard read "
