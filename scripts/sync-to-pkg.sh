...
PKG_REMOTE="git@codeberg.org:glitch-executor/glitch-grow-ai-social-media-agent-pkg.git"
PKG_LOCAL_DIR="${HOME}/glitch-grow-ai-social-media-agent-pkg"
