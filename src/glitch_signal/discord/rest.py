...
Bot token is read from /home/ubuntu/.config/glitch-discord/env at
...
_HOST_BOT_ENV = Path("/home/ubuntu/.config/glitch-discord/env")
...
# file inbox at /home/ubuntu/.glitch-discord/inbox/_interactions/. Each
# JSON file there is one button click; the host bot writes them, agents
# consume + delete.
# ---------------------------------------------------------------------------

INTERACTION_INBOX = Path("/home/ubuntu/.glitch-discord/inbox/_interactions/")
