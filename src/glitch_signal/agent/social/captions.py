...
async def write_captions(brand_id: str, idea: Idea, *, platforms: dict[str, str] | None = None,
    ...
    # Concurrently: the platforms are independent, and run in series this was N model round-trips
    # end to end — the single largest contributor to campaign wall-clock once per-platform captions
    # replaced the two per-medium ones.
    import asyncio
