...
# Hard cap on what we splice into a prompt. Generous enough for a real positioning doc, bounded so a
# runaway row can't blow the context window (and, with RLS + operator-only writes, can't be used to
# flood the prompt either).
MAX_LEN = 6000
